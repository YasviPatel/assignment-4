...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      }, //path:''
      {
        ...
        element: <ContactForm method="post" />,
        action: formAction,
      },
    ],
  },
