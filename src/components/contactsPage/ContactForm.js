      ...
      <Form method={method}>
        <div className={classes.form}>
          ...
          {error && error.phoneError && (
            <p className={classes.errorMessage}>{error.phoneError}</p>
          )}
          <br />
          Company:
          <input
            type={"text"}
            name="company"
            defaultValue={contactData ? contactData.company : ""}
          />
          <br />
          Address:
          <input
          ...
          <input
            type={"text"}
            name="designation"
            defaultValue={contactData ? contactData.designation : ""}
          />
          <br />
